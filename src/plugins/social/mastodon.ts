...
export class MastodonPlugin implements SocialPlugin {
  metadata: PluginMetadata = {
    id: 'social-mastodon',
    name: 'Mastodon',
    version: '1.0.0',
    author: 'ContentOS',
    description: 'Mastodon integration for posts, timelines, and analytics via ActivityPub',
    category: 'social',
    permissions: ['read', 'write', 'follow'],
    configSchema: {
      instanceUrl: { type: 'string', label: 'Instance URL', required: true },
