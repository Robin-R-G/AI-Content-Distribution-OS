...
export class TikTokPlugin implements SocialPlugin {
  metadata: PluginMetadata = {
    id: 'social-tiktok',
    name: 'TikTok',
    version: '1.0.0',
    author: 'ContentOS',
    description: 'TikTok integration for videos, posts, and analytics',
    category: 'social',
    permissions: ['user.info.basic', 'video.publish'],
    configSchema: {
      clientKey: { type: 'secret', label: 'Client Key', required: true },
